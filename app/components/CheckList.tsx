      ...
      <div className="flex flex-col md:flex-row items-center md:gap-4 md:justify-between w-full">
        ...
        <div className="flex gap-4">
          ...
          <div className="flex-1 ">
            ...
            <div className="flex items-center gap-2 mt-1 text-xs text-gray-400 py-1">
              <Image src={"/out2.svg"} alt="out" height={12} width={12} />{" "}
              Output: Commercial & Feasibility Report
            </div>

            <div className="flex gap-2 items-center">
              <LuFileText className="h-3 w-3 text-[#282E3480]" />{" "}
              <div className="mt-2 inline-flex items-center gap-2 bg-gray-100 text-gray-600 px-3 py-1 rounded text-[10px] md:text-xs">
                {detail}
              </div>
            </div>
          </div>
        ...
        <div className="md:flex flex-row items-center gap-1 hidden">
          <div className="flex-1 items-center text-center">
            <p className="bg-gray-100 text-gray-500 text-xs px-2 py-0.5 rounded">
              10 DAYS
            </p>
            <p className="text-[10px] font-bold text-gray-400 tracking-wider">
              PENDING
